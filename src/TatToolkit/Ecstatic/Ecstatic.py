...
def create_custom_dashed_line(img, start, end, dash_length_px=12, gap_length_px=12, color=0, thickness=1):
...
class Ecstatic:
    ...
    def draw_spaced_outlines(self, img, contour, color=0, dash_length=8, gap_length=13, thickness=1):
    ...
    def find_edges_and_smooth(self, segmented_image, num_thinning_iterations=3, epsilon=7, thickness=1):
